...
@section('content')
    <body class="bg-mainbg px-2">
        ...
        <div class="grid grid-cols-12 gap-2 py-2" x-data="{ selectedUser: null }">
            ...
            <!-- feedback section -->
            <div class="col-start-1 col-span-12 lg:col-span-8 bg-white shadow-lg px-6 rounded-md mt-2 relative">
            ...
            <div class="col-span-12 lg:col-start-9 lg:col-span-4 ">
                ...
                <div class="bg-white shadow-lg p-3 h-auto rounded-md mt-2 overflow-auto">
                    ...
                    <div class="px-10 py-2">
                        <button onclick="window.location.href = '{{ route('view-grant') }}'" class="w-full px-4 py-3 bg-btncolor text-white rounded-md hover:bg-opacity-80">
                            View All Request
                        </button>
                    </div>
                </div>
