...
<body class="bg-mainbg px-2">
    <div class="text-customIT text-2xl flex justify-between items-center mb-4">
        <h1 class="font-bold">Grant & Equipment Request</h1>
        ...
        <div class="flex justify-between items-center py-2 px-6">
            <button class="h-16 w-60 border-[3px] border-btncolor font-medium text-customIT rounded-md bg-snbg hover:bg-btncolor hover:text-white shadow">All</button>
            <button class="h-16 w-60 border-[3px] border-btncolor font-medium text-customIT rounded-md bg-snbg hover:bg-btncolor hover:text-white shadow">Pending</button>
            <button class="h-16 w-60 border-[3px] border-btncolor font-medium text-customIT rounded-md bg-snbg hover:bg-btncolor hover:text-white shadow">Completed</button>
            <button class="h-16 w-60 border-[3px] border-btncolor font-medium text-customIT rounded-md bg-snbg hover:bg-btncolor hover:text-white shadow">Rejected</button>
        </div>
