...
<!-- Add FAQ Modal -->
@if(Auth::user()->role_id == 3)
<div id="faq-modal" class="hidden fixed inset-0 bg-gray-900 bg-opacity-75 z-50 flex items-center justify-center p-6">
    <div class="bg-white rounded-xl w-full max-w-2xl shadow-2xl p-8 animate__animated animate__fadeIn">
        <div class="flex justify-between items-center mb-6">
...
<!-- Admin Only Modal -->
<div id="admin-only-modal" class="hidden fixed inset-0 bg-gray-900 bg-opacity-50 z-50 flex items-center justify-center p-4">
