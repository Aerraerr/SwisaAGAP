        ...
        <form method="POST" action="{{ route('admin.users.store') }}">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div class="col-span-2">
                    <label class="block text-sm text-gray-700 font-medium">Role</label>
                ...
                <div>
                    <label class="flex items-center gap-1 text-gray-700 font-medium">
                        ...
                        <div class="relative group cursor-pointer">
                            <div class="w-5 h-5 flex items-center justify-center border border-gray-400 rounded-full text-xs font-bold text-gray-500">
                                ?
                            </div>

                            <span class="absolute left-6 top-1/2 -translate-y-1/2 bg-gray-800 text-white text-xs rounded-md px-2 py-1 mt-1 shadow-md w-40 opacity-0 group-hover:opacity-100 transition-opacity duration-200">
                                - Address<br>
                                - Barangay<br>
                ...
                <div>
                    ...
                    <div class="relative">
                        ...
                        <button type="button" onclick="togglePassword('password', this)"
                            class="absolute inset-y-0 right-2 flex items-center text-gray-600"></button>
                    </div>
                </div>
...
<script>
    ...
    document.getElementById('role_id').addEventListener('change', function () {
        ...
        if (this.value == '2') { // Support Staff
            ...
            lastNameLabel.childNodes[0].textContent = 'Location';
            locationHint.classList.remove('hidden');
        } else {
            firstNameLabel.textContent = 'First Name';
            lastNameLabel.childNodes[0].textContent = 'Last Name';
