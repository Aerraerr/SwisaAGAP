    ...
    <div class="">
        ...
        <div class="grid grid-cols-2 gap-4 text-sm text-gray-600 mb-2">
            ...
            <div>
                ...
                <p class="font-medium ml-5 text-sm">Pending: <span class="text-gray-600 ml-1">{{ $pendingRequests }}</span></p>
                <p class="font-medium ml-5 text-sm">Approved: <span class="text-gray-600 ml-1">{{ $approved }}</span></p>
            </div>
            ...
            <div>
                ...
                <p class="font-medium ml-5 text-sm">Added On: <span class="text-gray-600 ml-1">{{ $addedOn }}</span></p>
                <p class="font-medium ml-5 text-sm">Last Updated: <span class="text-gray-600 ml-1">{{ $lastUpdated }}</span></p>
            </div>
        </div>
