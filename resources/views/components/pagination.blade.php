...
<div class="text-right pt-4 px-4 bottom-0 left-0 right-0">
    ...
    <nav class="relative z-0 inline-flex rounded-md text-xs shadow-sm -space-x-px gap-1" aria-label="Pagination">
        <a href="#" class="flex ring-1 ring-inset ring-gray-300 items-center text-bsctxt rounded-[4px] bg-white hover:bg-btncolor hover:text-white cursor-pointer focus:z-20 focus:outline-offset-0 py-1">
