...
<div class="w-full sm:w-[320px] md:w-[360px] lg:w-[380px] bg-white p-6 rounded-md shadow-xl flex flex-col space-y-2">
    ...
    <div class="flex justify-between ml-0 sm:ml-20 text-xs text-gray-600">
