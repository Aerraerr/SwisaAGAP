<div id="addSectorModal" class="hidden fixed inset-0 bg-gray-600 bg-opacity-50 overflow-y-auto z-20 h-full w-full flex items-center justify-center">
    <div class="relative w-full max-w-2xl mx-auto p-6 border shadow-lg rounded-xl bg-white transition-transform transform scale-95 duration-300">
        ...
        <div class="flex items-center justify-between pb-2">
            <div class="items-center">
                <h2 class="text-3xl font-bold text-customIT">Add Sector</h2>
            </div>
            <div>
                <button onclick="closeModal('addSectorModal')" class="text-gray-400 hover:text-gray-600 transition-colors duration-200">
        ...
        <form action="{{ route('admin.sector.store')}}" method="POST" 
            ...
            <div class="mt-4 m-8 space-y-2 max-h-[85vh] overflow-auto px-1">
                <div>
                    <label class="block text-sm font-medium text-gray-700">Sector Name</label>
            ...
            <div class="text-right px-4 py-3">
                <button type="button" onclick="closeModal('addSectorModal')" class="w-1/3 px-4 py-2 bg-cancel text-gray-500 rounded-md hover:bg-gray-400 hover:text-white">
                    Cancel
                </button>
