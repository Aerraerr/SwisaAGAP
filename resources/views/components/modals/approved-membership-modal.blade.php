    ...
    <div class="relative w-1/3 max-auto p-6 border shadow-lg rounded-xl bg-white transition-transform transform scale-95 duration-300">
        ...
        <div class="flex items-center justify-between pb-2">
            <div class="flex items-center">
                ...
                <h3 class="text-2xl font-bold text-customIT">Approved this Application?</h3>
            </div>
            <div>
        ...
        <div class="mt-4 m-8">
            <div class="items-center">
                ...
                <p class="text-sm text-gray-600 mt-2">Please confirm whether you want to approve or reject this membership application.</p>
            </div>
        </div>
        <!-- modal footer -->
        ...
        @include('components.modals.reject-membership', ['modalId' => 'rejectReasonModal'])
    </div>
</div>