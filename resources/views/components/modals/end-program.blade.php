<div id="endProgramModal" class="hidden fixed inset-0 bg-gray-600 bg-opacity-50 overflow-y-auto z-20 h-full w-full flex items-center justify-center">
    <div class="relative w-1/3 max-auto p-6 border shadow-lg rounded-xl bg-white transition-transform transform scale-95 duration-300">
        ...
        <div class="flex items-center justify-between pb-2">
            <div class="flex items-center">
                ...
                <h3 class="text-2xl font-bold text-customIT">End Program?</h3>
            </div>
            <div>
                <button onclick="closeModal('endProgramModal')" class="text-gray-400 hover:text-gray-600 transition-colors duration-200">
        ...
        <div class="text-right px-4 py-3">
            <button onclick="closeModal('endProgramModal')" class="w-1/3 px-4 py-2 bg-white text-btncolor rounded-md border border-btncolor hover:bg-btncolor hover:text-white">
                Cancel
            </button>
