<div id="assistMembershipModal-{{ $member->id}}" class="hidden fixed inset-0 bg-gray-600 bg-opacity-50 z-20 h-full w-full flex items-center justify-center">
  <div class="relative w-auto max-w-6xl mx-auto p-6 border shadow-lg rounded-xl bg-white transition-transform transform scale-95 duration-300">
    ...
    <div class="flex items-center justify-between pb-4 border-b">
      <div>
        <h2 class="text-2xl font-bold text-customIT">Apply Membership</h2>
            ...
            <div>
              ...
              <select name="sex" class="w-full mt-1 px-3 py-2 border border-gray-300 rounded-md focus:ring-btncolor focus:border-btncolor focus:ring-opacity-30">
                ...
                <div>
                  ...
                  <input type="email" name="email" value="{{ $member->email ?? 'email address'}}" class="w-full mt-1 px-3 py-2 border border-gray-300 rounded-md focus:ring-btncolor focus:border-btncolor focus:ring-opacity-30">
                </div>
          </div>
        </div>
          ...
          <div class="grid grid-cols-1 md:grid-cols-3 gap-3">
            ...
            <div>
                ...
                <div>
                  ...
                  <input type="text" name="sc_purok" value="{{ $member->user_info->sc_zone ?? 'purok'}}" class="w-full mt-1 px-3 py-2 border border-gray-300 rounded-md focus:ring-btncolor focus:border-btncolor focus:ring-opacity-30">
                </div>
                <div>
        ...
        <div>
          ...
          <div class="grid grid-cols-1 md:grid-cols-2 gap-3">
                ...
                <div>
                  ...
                  <input type="text" name="farm_location" value="{{ $member->user_info->farm_location ?? 'location'}}" class="w-full mt-1 px-3 py-2 border border-gray-300 rounded-md focus:ring-btncolor focus:border-btncolor focus:ring-opacity-30">
                </div>
                <div>
