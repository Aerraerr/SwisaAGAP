<div id="assistMembershipModal" class="hidden fixed inset-0 bg-gray-600 bg-opacity-50 z-20 h-full w-full flex items-center justify-center">
  <div class="relative w-auto max-w-4xl mx-auto p-6 border shadow-lg rounded-xl bg-white transition-transform transform scale-95 duration-300">
    ...
    <div class="mt-4 space-y-6 max-h-[80vh] overflow-y-auto px-4">
      ...
      <div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-3">
          ...
          <input type="text" name="other_purpose" placeholder="other answer" class="input-field rounded-[4px] border-btncolor text-customIT focus:border-btncolor focus:ring focus:ring-btncolor focus:ring-opacity-30">
        </div>
      </div>
    ...
    <div class="text-right px-4 py-3">
        <button onclick="closeModal('assistMembershipModal')" class="w-1/3 px-4 py-2 bg-cancel text-gray-500 rounded-md hover:bg-gray-400 hover:text-white">
            Cancel
        </button>
