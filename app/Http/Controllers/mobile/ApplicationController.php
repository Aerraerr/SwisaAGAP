...
class ApplicationController extends Controller
{
    ...
    /**
     * ✅ GET SINGLE APPLICATION BY ID - WITHOUT CONTRIBUTIONS
     * Used in "View Status" screen - contributions are NOT shown here anymore
     */
        ...
        try {
            ...
            return response()->json([
                ...
                'application' => [
                    ...
                    // ❌ CONTRIBUTIONS REMOVED - Not shown in View Status anymore
                ],
            ], 200);
